...
const WelcomeBalance = () => {
  ...
  const closeSession = async () => {
    ...
    store.update((state) => {state.list.create.id = ''})
    store.update((state) => {state.list.create.status = ''})
  ...
  return (
    ...
    >
      <View style={{ flexDirection: "row", justifyContent: "center" }}>
        <IconH name="address-card" color="rgba(0,0,0,0.75)" size={80} />
        <Text
          style={{
            alignSelf: "center",
            marginLeft: 20,
      ...
      <View style={{ marginTop: 10 }}>
        ...
        <Pressable
          style={[styles.button, styles.buttonOpen, {marginTop: 10, backgroundColor: '#DC3444'}]}
